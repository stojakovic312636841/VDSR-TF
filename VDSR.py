	...
	with tf.Session(config=config) as sess:
		...
		if USE_QUEUE_LOADING:
			...
			for epoch in xrange(0, MAX_EPOCH):
				...
				saver.save(sess, "./ckpt/VDSR_adam_epoch_%03d.ckpt" % epoch ,global_step=global_step)
		else:
			for epoch in xrange(0, MAX_EPOCH):
				...
				#saver.save(sess, "./ckpt/VDSR_const_clip_0.01_epoch_%03d.ckpt" % epoch ,global_step=global_step)
